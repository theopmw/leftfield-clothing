"""
Django settings for leftfield_clothing project.
...
ALLOWED_HOSTS = ['leftfield-clothing-theopmw.herokuapp.com', 'localhost']
...
ROOT_URLCONF = 'leftfield_clothing.urls'
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'leftfield-clothing-theopmw'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'leftfieldfclothing@example.com'
else:
    EMAIL_BACKEND = 'django.core.mail.backends.stmp.EmailBackend'
    EMAIL_USE_TLS = True
    EMAIL_PORT = 587
    EMAIL_HOSTn = 'smpt.gmail.com'
    EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER')
    EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASS')
    DEFAULT_FROM_EMAIL = 'theowrightdev@gmail.com'
